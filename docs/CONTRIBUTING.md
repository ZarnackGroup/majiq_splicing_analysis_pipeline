...
# `ZarnackGroup/majiq_splicing_analysis_pipeline`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving ZarnackGroup/majiq_splicing_analysis_pipeline.

This page describes the recommended nf-core way to contribute to both ZarnackGroup/majiq_splicing_analysis_pipeline and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of ZarnackGroup/majiq_splicing_analysis_pipeline.
...
- [ ] Check whether a GitHub [issue](https://github.com/ZarnackGroup/majiq_splicing_analysis_pipeline/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [ZarnackGroup/majiq_splicing_analysis_pipeline repository](https://github.com/ZarnackGroup/majiq_splicing_analysis_pipeline) to your GitHub account.
...
nf-core semi-standardises how you write code and other contributions to make the ZarnackGroup/majiq_splicing_analysis_pipeline code and processing logic more understandable for new contributors and to ensure quality.

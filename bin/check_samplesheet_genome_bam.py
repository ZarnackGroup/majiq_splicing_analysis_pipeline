        ...
        **kwargs,
        ...
        Args:
            sample_col (str): The name of the column that contains the sample name
                (default "sample").
            genome_bam_col (str): The name of the column that contains the transcriptome
                BAM file path (default "genome_bam").

        """
        super().__init__(**kwargs)
        self._sample_col = sample_col
        self._genome_bam_col = genome_bam_col
